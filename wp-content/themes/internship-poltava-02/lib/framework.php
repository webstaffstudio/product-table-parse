<?php
/**
 * Various functions required for internship_poltava_02-bootstrap to work properly
 *
...
/**
 * internship_poltava_02_navwalker class
 * Menu navigation walker
 * Class Name: internship_poltava_02_navwalker
 * GitHub URI: https://github.com/twittem/wp-internship_poltava_02-navwalker
 * Description: A custom WordPress nav walker class to implement the internship_poltava_02 3 navigation style in a custom theme using the WordPress built in menu manager.
 */
class Internship_poltava_02_Navwalker extends Walker_Nav_Menu {
	/**
	 * Walker::start_lvl()
	 *
...
/**
 * Pagination
 * Custom pagination with internship_poltava_02 .pagination class
 * source: http://www.ordinarycoder.com/paginate_links-class-ul-li-internship_poltava_02/
 *
 * @param boolean $echo echo
 * @return string
 */
function internship_poltava_02_pagination( $echo = true ) {
	global $wp_query;
...
/**
 * 4 - Comments tree
 * internship_poltava_02 Comments Tree
 */
if ( ! class_exists( 'Internship_poltava_02_Comments' ) ) :
	/**
	 * Undocumented class
	 */
	class Internship_poltava_02_Comments extends Walker_Comment {
		/**
		 * tree_type
		 *
