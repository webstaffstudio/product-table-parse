...
if ( ! class_exists( 'Internship_poltava_02_Protocol_Relative_Theme_Assets' ) ) :

	/**
	 * Internship_poltava_02_Protocol_Relative_Theme_Assets class
	 */
	class Internship_poltava_02_Protocol_Relative_Theme_Assets {
		/**
	...
	$internship_poltava_02_protocol_relative_theme_assets = new Internship_poltava_02_Protocol_Relative_Theme_Assets();
endif;
