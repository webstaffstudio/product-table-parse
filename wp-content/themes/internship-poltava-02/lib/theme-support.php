...
if ( ! function_exists( 'internship_poltava_02_theme_support' ) ) :
	/**
	 * Add theme supports
	 */
	function internship_poltava_02_theme_support() {
	...
	add_action( 'after_setup_theme', 'internship_poltava_02_theme_support' );
endif;
